...
/**
    ...
    notched reel hub, Reverse's leftward arrow, Clear's X, Auto-Record's level bars +
    threshold line) -- see drawButtonText().
...
public:
    ...
    static constexpr const char* iconAutoRecord    = "icon:autoRecord";     // level bars + a threshold line
